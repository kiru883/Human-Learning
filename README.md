Мои заметки/конспекты чтобы не забыть, будут дополняться/исправляться, ПОЖАЛУЙСТА укажите ошибки, буду очень благодарен!
...
Ссылки
  ...
  # (BI)LSTM / Seq2seq
  ![](https://github.com/kiru883/Courses/blob/master/CV%20notes/images/LSTM.JPG)
